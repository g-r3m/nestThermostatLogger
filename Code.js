 ...
 * MYCITYID: You can find ID here: https://openweathermap.org/find
 * Register to this website to generate an API key to use the product 
 * TO DO: 
 * Add MYCITY and APIKEY in GlobalVariables.gs
 */
...
function retrieveWeather() {
  ...
  try {
    ...
    const textDescription = weatherData['name'];
    ...
    const seaLevelPressure = weatherData['main']['pressure'];
    const visibility = weatherData['main']['visibility'];
    const relativeHumidity = weatherData['main']['humidity'];
    const windChill = weatherData['wind']['speed'];
